...
import static juegos_reunidos.IniciarOca.saNmbJugadores;     // import static JuegosReunidos.IniciarOca.saNmbJugadores --> ¿Se pone para poder importar+heredar los array?
...
class CCasillasOca extends IniciarOca{
...
class CDadoFicha extends IniciarOca{
    void mTirarDado(){
        for (int i = 0; i < saNmbJugadores.length; i++){
